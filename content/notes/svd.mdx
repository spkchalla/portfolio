...
e_{1} = \frac{x_{p}}{\sqrt{x_{p}^{T} x_{p}}}
$$
⚠️ I need to mention that I am not quite sure of how did we end up in the closed form solution of the eigen values and eigen vectors. I need to work on it.